...
implements Statement {
	...
	public boolean isClosed() throws SQLException {
		...
		return ((Connection) reference).isClosed();
	}

	public void setPoolable(boolean poolable) throws SQLException {
		
		((BaseStatementDecorator) reference).setPoolable(poolable);
	}

	public boolean isPoolable() throws SQLException {
		
		return ((BaseStatementDecorator) reference).isPoolable();
	}

	public <T> T unwrap(Class<T> iface) throws SQLException {
		
		return ((BaseStatementDecorator) reference).unwrap(iface);
	}

	public boolean isWrapperFor(Class<?> iface) throws SQLException {
		
		return ((BaseStatementDecorator) reference).isWrapperFor(iface);
	}
